...
<html lang="en">
    <head>
        ...
        <title>Students who at least pass the quiz</title>
    </head>
    <body>
        <h1>Students who at least pass the quiz</h1>
        <?php 
            ...
            $query = "SELECT * FROM quizAnswers WHERE score > 50 ";
            ...
            if ($conn) {
                ...
                if ($result) {
                    ...
                    if (!$record) {
                        ...
                        echo "<table border=\"1\">\n";
                        echo "<tr><th>Student ID</th><th>First Name</th><th>Last Name</th><th>Attempts</th><th>Date & Time</th></tr>";
