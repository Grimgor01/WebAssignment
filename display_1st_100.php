...
<html lang="en">
    <head>
        ...
        <title>Students who got 100% in the first attempt</title>
    </head>
    <body>
        <h1>Students who got 100% in the first attempt</h1>
        <?php 
            ...
            $query = "SELECT * FROM quizAnswers WHERE attempts = 1 AND score = 100 ";
